...
public class AddReceipt extends javax.swing.JFrame {
    ...
    ConnectToDatabaseSys paramDB2 = new ConnectToDatabaseSys();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(textOrno, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textOrdt, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textOrdetail, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textOramt, javax.swing.GroupLayout.Alignment.LEADING)))
                    .addGroup(layout.createSequentialGroup()
    ...
    public void secondQuery() throws SQLException{
        ...
        clid=0;regid=0; edid=0;emid=0;calid=0;
        ResultSet rs, rs2;
        this.connect();
        Statement stmt = null;
        try
        {
            ...
            while(rs.next())
           {
               memberid=rs.getString("memberid");
                System.out.println("in2ndqrsnxt member"+rs.getString("memberid"));
                ...
                //ArrayList<Integer> aGoods= new ArrayList<>();
                double goodsBal=goods;
                String query3;
                Connection conn2;
                this.connect();
                conn2=this.getConnection();
                query3= "select invdtlid, balance from goods_sold_dtl where memberid="+memberid+" and balance>0 order by invdtlid asc";
                
                Statement stmt2 = null;
                stmt2 = conn2.createStatement();
                rs2 = stmt2.executeQuery(query3);
                while(rs2.next()&&goodsBal>0)
                {
                    
                    if(rs2.getFloat(2)>goodsBal)
                        query3 = "Update goods_sold_dtl set balance=balance-"+goodsBal+" where memberid="+memberid+" and invdtlid="+rs2.getInt(1);
                    if(rs2.getFloat(2)<goodsBal)
                        query3 = "Update goods_sold_dtl set balance=0 where memberid="+memberid+" and invdtlid="+rs2.getInt(1);
                    if(rs2.getFloat(2)==goodsBal)
                        query3 = "Update goods_sold_dtl set balance=balance-"+goodsBal+" where memberid="+memberid+" and invdtlid="+rs2.getInt(1);
                    
                    goodsBal-=rs2.getFloat(2);
                    System.out.println(goodsBal);
                    stmt2.addBatch(query3);
                }
            ...
            System.out.println("ortotal"+ortotal);
            String query3 = "Update or_dtl set memtotal="+ortotal +"where ordtlid="+ordtlid; 
            connectDB.executeQuery(query3);
    ...
    {        //get all details subledger needs
        ...
        System.out.println("sub1query"+query);
        ResultSet rs;
        this.connect();
        Statement stmt = null;
       ...
       float premium, interest, penalty ;
        ...
        try
        {
            ...
            //System.out.println("in sub1 while"+loanid+" "+rs.getString("mon_interest"));
                ...
                interest=rs.getFloat("mon_interest");
                premium=rs.getFloat("mon_premium");
                    System.out.println("pumasok dito sa zero");
                }
    ...
    private void subledger2(ArrayList<ArrayList> arrayL) throws SQLException {
        String query3;
        this.getORDTLID();
        ...
        for(int i=0; i<arrayL.size(); i++){
            ...
            if(arrayTemp.get(0).matches("reg")){
                ...
                stmt.addBatch(query3);
                //paramDB2.accessLoopDatabase(query3);
                System.out.println("in reg insert"+ordtlid+" "+arrayTemp.get(1)+" "+arrayTemp.get(2)+" "+arrayTemp.get(3)+" "+arrayTemp.get(4)+" "+arrayTemp.get(5)+" "+arrayTemp.get(6));
            
                query3= "update loan_hdr set balance=balance-"+arrayTemp.get(5)+"-"+arrayTemp.get(6)+
                        " where loanid="+arrayTemp.get(1);
                stmt.addBatch(query3);
                //paramDB.accessLoopDatabase(query3);
                stmt.executeBatch();
            }
                ...
                System.out.println("in edinsert"+ordtlid+" "+arrayTemp.get(1)+" "+arrayTemp.get(2)+" "+arrayTemp.get(3)+" "+arrayTemp.get(4)+" "+arrayTemp.get(5)+" "+arrayTemp.get(6));
                query3= "update loan_hdr set balance=balance-"+arrayTemp.get(5)+"-"+arrayTemp.get(6)+
                        " where loanid="+arrayTemp.get(1);
                stmt.addBatch(query3);
                //paramDB.accessLoopDatabase(query3);
        ...
        //System.out.println("2size"+arrayTemp.size());
                ...
                query3= "update loan_dtl set mon_premium_bal=mon_premium_bal-"+arrayTemp.get(5)+", mon_interest_bal=mon_interest_bal-"+arrayTemp.get(6)+
                        " where loandtlid="+arrayTemp.get(2);
                System.out.println("in eminsert"+ordtlid+" "+arrayTemp.get(1)+" "+arrayTemp.get(2)+" "+arrayTemp.get(3)+" "+arrayTemp.get(4)+" "+arrayTemp.get(5)+" "+arrayTemp.get(6));
                stmt.addBatch(query3);
                //paramDB2.accessLoopDatabase(query3);
                query3= "update loan_hdr set balance=balance-"+arrayTemp.get(5)+"-"+arrayTemp.get(6)+
                        " where loanid="+arrayTemp.get(1);
