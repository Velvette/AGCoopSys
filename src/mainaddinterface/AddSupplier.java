...
public class AddSupplier extends javax.swing.JFrame {
    ...
    public void checkInputAddSupplier()
    {
        ...
        String supplierUpper = supplierName.toUpperCase();
        
        try
        {
            if(!supplierTest.equals(supplierUpper))
                if(!(connectDB.checkDuplicate(validateInputs.removeSpaces(supplierUpper),0)))
                {
        ...
        if(errorCount == 0)
        {
            ...
            if(choice == 0)
            {
                    query = "insert into supplier (suppname,address1,address2,address3,contactperson,contactno1,contactno2,email,balance,suppvname) values ('"
                    + supplierName + "','" + supplierAddress1 + "','" + supplierAddress2 + "','" + supplierAddress3 + "','" + supplierContactPerson + "','" + supplierContact1 + "','" + supplierContact2 + "','"
                    + supplierEmail + "','" + supplierBalance+"','"+supplierUpper+ "')";
            }
            if(choice == 1)
            {
                query = "update supplier set suppname='"+supplierName+"',address1='"+supplierAddress1+"',address2='"+supplierAddress2+"',address3='"+supplierAddress3+"',"+
                        "contactperson='"+supplierContactPerson+"',contactno1='"+supplierContact1+"',contactno2='"+supplierContact2+"',email='"+supplierEmail+"',balance='"+supplierBalance+"',suppvname='"+supplierName+"' where suppid="+supplierID;
    ...
    public void checkInputEditSupplier(String id)
    {
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                supplierTest = rs.getString("suppname").toUpperCase();
